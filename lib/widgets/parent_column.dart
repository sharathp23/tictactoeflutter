...
import 'package:flutter_tictactoe/widgets/name_text_field_widget.dart';
import 'package:flutter_tictactoe/widgets/row_contains_avatar_and_images1.dart';
import 'package:flutter_tictactoe/Models/UiLogic.dart';
import 'package:flutter_tictactoe/widgets/row_contains_avatar_and_images2.dart';
      ...
      child: Column(
        children: [
          Padding(
            ...
            child: Text("SETTINGS", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 25.0)),
          ),
          kDivider,
          Row(
